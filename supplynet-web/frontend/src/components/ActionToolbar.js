...
function ActionToolbar({ 
  ...
  return (
    ...
    >
      ...
      >
        <MenuItem onClick={() => { onAddNode('supplier'); setBuildMenuAnchor(null); }}>
          <ListItemIcon><LocalShippingIcon fontSize="small" color="primary" /></ListItemIcon>
          <ListItemText primaryTypographyProps={{ fontSize: '0.875rem', fontWeight: 500 }}>
            Add Supplier
          </ListItemText>
        </MenuItem>
        <MenuItem onClick={() => { onAddNode('distributor'); setBuildMenuAnchor(null); }}>
          <ListItemIcon><StorefrontIcon fontSize="small" color="primary" /></ListItemIcon>
          <ListItemText primaryTypographyProps={{ fontSize: '0.875rem', fontWeight: 500 }}>
            Add Distributor
          </ListItemText>
        </MenuItem>
        <MenuItem onClick={() => { onAddDemand(); setBuildMenuAnchor(null); }}>
          <ListItemIcon><ShoppingCartIcon fontSize="small" color="primary" /></ListItemIcon>
          <ListItemText primaryTypographyProps={{ fontSize: '0.875rem', fontWeight: 500 }}>
            Add Demand
          </ListItemText>
        </MenuItem>
      ...
      >
        <MenuItem onClick={() => { onSaveScenario(); setAnalyzeMenuAnchor(null); }} disabled={!hasResults}>
          <ListItemIcon><BookmarkIcon fontSize="small" color="primary" /></ListItemIcon>
          <ListItemText primaryTypographyProps={{ fontSize: '0.875rem', fontWeight: 500 }}>
            Save Scenario
          </ListItemText>
        </MenuItem>
        <MenuItem onClick={() => { onCompareScenarios(); setAnalyzeMenuAnchor(null); }}>
          <ListItemIcon><CompareArrowsIcon fontSize="small" color="primary" /></ListItemIcon>
          <ListItemText primaryTypographyProps={{ fontSize: '0.875rem', fontWeight: 500 }}>
            Compare Scenarios
            {stats.scenarios > 0 && (
              <Chip label={stats.scenarios} size="small" sx={{ ml: 1, height: 18, fontSize: '0.7rem' }} />
            )}
          </ListItemText>
        </MenuItem>
      </Menu>
      ...
      >
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5 }}>
          <CircleIcon sx={{ fontSize: 6, color: 'secondary.main' }} />
          <Typography variant="caption" sx={{ color: 'text.secondary', fontSize: '0.75rem', fontWeight: 500 }}>
            {stats.links} links
          </Typography>
        </Box>
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5 }}>
          <CircleIcon sx={{ fontSize: 6, color: 'info.main' }} />
          <Typography variant="caption" sx={{ color: 'text.secondary', fontSize: '0.75rem', fontWeight: 500 }}>
            {stats.demands} demands
          </Typography>
        </Box>
      </Stack>
      ...
      <Tooltip title="Simulation Duration">
        ...
        >
          ...
          />
          <Typography variant="caption" sx={{ color: 'text.secondary', fontSize: '0.7rem', ml: 0.3 }}>
            days
          </Typography>
        </Box>
      </Tooltip>
      ...
      >
        <MenuItem onClick={() => { onSaveConfig(); setFileMenuAnchor(null); }} disabled={stats.nodes === 0}>
          <ListItemIcon><FileDownloadIcon fontSize="small" color="primary" /></ListItemIcon>
          <ListItemText primaryTypographyProps={{ fontSize: '0.875rem', fontWeight: 500 }}>
            Export Configuration
          </ListItemText>
        </MenuItem>
        <MenuItem onClick={() => { onLoadConfig(); setFileMenuAnchor(null); }}>
          <ListItemIcon><FileUploadIcon fontSize="small" color="primary" /></ListItemIcon>
          <ListItemText primaryTypographyProps={{ fontSize: '0.875rem', fontWeight: 500 }}>
            Import Configuration
          </ListItemText>
        </MenuItem>
        <Divider sx={{ my: 0.5 }} />
        <MenuItem onClick={() => { onSaveNetwork(); setFileMenuAnchor(null); }} disabled={stats.nodes === 0}>
          <ListItemIcon><FolderIcon fontSize="small" color="primary" /></ListItemIcon>
          <ListItemText primaryTypographyProps={{ fontSize: '0.875rem', fontWeight: 500 }}>
            Save Network
          </ListItemText>
        </MenuItem>
        <MenuItem onClick={() => { onViewNetworks(); setFileMenuAnchor(null); }}>
          <ListItemIcon><FolderIcon fontSize="small" color="primary" /></ListItemIcon>
          <ListItemText primaryTypographyProps={{ fontSize: '0.875rem', fontWeight: 500 }}>
            My Networks
            {stats.savedNetworks > 0 && (
              <Chip label={stats.savedNetworks} size="small" sx={{ ml: 1, height: 18, fontSize: '0.7rem' }} />
            )}
          </ListItemText>
        </MenuItem>
      </Menu>
      ...
      >
        <MenuItem onClick={() => { setHelpMenuAnchor(null); onMenuClick('help'); }}>
          <ListItemIcon><HelpOutlineIcon fontSize="small" color="primary" /></ListItemIcon>
          <ListItemText primaryTypographyProps={{ fontSize: '0.875rem', fontWeight: 500 }}>
            Help & Docs
          </ListItemText>
        </MenuItem>
        <MenuItem onClick={() => { setHelpMenuAnchor(null); onMenuClick('about'); }}>
      ...
      >
        ...
        <MenuItem onClick={() => { setUserMenuAnchor(null); onMenuClick('settings'); }} sx={{ py: 1.5 }}>
        ...
        <Divider sx={{ my: 0.5 }} />
        <MenuItem onClick={() => { setUserMenuAnchor(null); onMenuClick('logout'); }} sx={{ py: 1.5 }}>
